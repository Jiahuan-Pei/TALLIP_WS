...
from Single.linearcombination_web import *
import codecs
import numpy
import random
import math
...
def run_experiment(hypers):
    ...
    print_word_vectors(current_experiment.pretrained_word_vectors, macro.RESULTS_DIR+r'/org_vectors.txt')
    print_word_vectors(transformed_word_vectors, macro.RESULTS_DIR+r"/counter_fitted_vectors.txt")
    return hypers_str
