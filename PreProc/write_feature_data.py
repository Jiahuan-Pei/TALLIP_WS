...
def write_features(word_list_file_name):
    ...
    out_file = codecs.open(macro.CORPUS_DIR + '/features_golden_new_8.txt', 'w', 'utf-8')
    out_file.write(
        'ID,Word1,Word2,web-jaccard,web-overlap,web-dice,web-pmi,ngd,pinyin_sim,seq_sim,pattern_sim\r\n')
